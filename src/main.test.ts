...
test("should create fraction", () => {
  ...
  equal(new Fraction(1, -2).toPair(), [-1, 2])
  equal(new Fraction(-1, -2).toPair(), [1, 2])
  equal(new Fraction(4, 2).toPair(), [4, 2])
  ...
  equal(fraq(0.5).toPair(), [5, 10])
  equal(fraq(1.5).toPair(), [15, 10])
  equal(fraq(-0.5).toPair(), [-5, 10])
  equal(fraq(-1.5).toPair(), [-15, 10])

  equal(fraq(0.5).reduce().toPair(), [1, 2])
  equal(fraq(1.5).reduce().toPair(), [3, 2])
  equal(fraq(-0.5).reduce().toPair(), [-1, 2])
  equal(fraq(-1.5).reduce().toPair(), [-3, 2])
})
...
test("other", () => {
  ...
  equal(new Fraction(0, -1).toString(), "0")
  equal(new Fraction(6, 2, true).toString(), "3")
...
test("should parse from string", () => {
  ...
  equal(fraq("2 9/3").reduce().toPair(), [5, 1])
  equal(fraq("3 27/9").reduce().toPair(), [6, 1])

  equal(fraq("0.5").reduce().toPair(), [1, 2])
  equal(fraq("1.5").reduce().toPair(), [3, 2])
  equal(fraq("-0.5").reduce().toPair(), [-1, 2])
  equal(fraq("-1.5").reduce().toPair(), [-3, 2])
  equal(fraq(".5").reduce().toPair(), [1, 2])
  equal(fraq("-.5").reduce().toPair(), [-1, 2])
  equal(fraq(".0").reduce().toPair(), [0, 1])
  equal(fraq("-.0").reduce().toPair(), [0, 1])
...
test("should print to ascii", () => {
  equal(fraq("0").toAscii(), "0")
  equal(fraq("1").toAscii(), "1")
  equal(fraq("2").toAscii(), "2")
  equal(fraq("-0").toAscii(), "0")
  equal(fraq("-1").toAscii(), "-1")
  equal(fraq("-2").toAscii(), "-2")

  equal(fraq("1/1").toAscii(), "1")
  equal(fraq("1/2").toAscii(), "1/2")
  equal(fraq("1/3").toAscii(), "1/3")
  equal(fraq("3/2").toAscii(), "1 1/2")
  equal(fraq("3/4").toAscii(), "3/4")
  equal(fraq("-1/2").toAscii(), "-1/2")
  equal(fraq("1/-2").toAscii(), "-1/2")
  equal(fraq("1.0").toAscii(), "1")

  // equal(fraq(".0625").toAscii(), "5/8")
  // equal(fraq(".083").toAscii(), "5/6")
  // equal(fraq(".1875").toAscii(), "1/5")
  // equal(fraq(".3125").toAscii(), "3/10")
  // equal(fraq(".4375").toAscii(), "4/9")
  // equal(fraq(".5625").toAscii(), "5/9")
  // equal(fraq(".6875").toAscii(), "7/10")
  // equal(fraq(".8125").toAscii(), "4/5")
  // equal(fraq(".833").toAscii(), "5/6")
  // equal(fraq(".9375").toAscii(), "9/10")

  equal(fraq(".0625").toAscii(), "1/16")
  equal(fraq(".083").toAscii(), "1/12")
  equal(fraq(".1875").toAscii(), "3/16")
  equal(fraq(".3125").toAscii(), "5/16")
  equal(fraq(".4375").toAscii(), "7/16")
  equal(fraq(".5625").toAscii(), "9/16")
  equal(fraq(".6875").toAscii(), "11/16")
  equal(fraq(".8125").toAscii(), "13/16")
  equal(fraq(".9375").toAscii(), "15/16")

  equal(fraq(".1").toAscii(), "1/10")
  equal(fraq(".111").toAscii(), "1/9")
  equal(fraq(".125").toAscii(), "1/8")
  equal(fraq(".143").toAscii(), "1/7")
  equal(fraq(".166").toAscii(), "1/6")
  equal(fraq(".2").reduce().toAscii(), "1/5")
  equal(fraq(".25").toAscii(), "1/4")
  equal(fraq(".3").toAscii(), "3/10")
  equal(fraq(".33").toAscii(), "1/3")
  equal(fraq(".375").toAscii(), "3/8")
  equal(fraq(".4").reduce().toAscii(), "2/5")
  equal(fraq(".5").reduce().toAscii(), "1/2")
  equal(fraq(".6").reduce().toAscii(), "3/5")
  equal(fraq(".625").toAscii(), "5/8")
  equal(fraq(".66").toAscii(), "2/3")
  equal(fraq(".7").toAscii(), "7/10")
  equal(fraq(".75").toAscii(), "3/4")
  equal(fraq(".8").reduce().toAscii(), "4/5")
  equal(fraq(".875").toAscii(), "7/8")
  equal(fraq(".9").toAscii(), "9/10")

  equal(fraq("1/64").toAscii(64), "1/64")
  equal(fraq("1 1/64").toAscii(64), "1 1/64")
  equal(fraq("1 1/64").toAscii(), "1")
})

test("should print to unicode", () => {
  equal(fraq("0").toUnicode(), "0")
  equal(fraq("1").toUnicode(), "1")
  equal(fraq("2").toUnicode(), "2")
  equal(fraq("-0").toUnicode(), "0")
  equal(fraq("-1").toUnicode(), "-1")
  equal(fraq("-2").toUnicode(), "-2")

  equal(fraq("1/1").toUnicode(), "1")
  equal(fraq("1/2").toUnicode(), "½")
  equal(fraq("1/3").toUnicode(), "⅓")
  equal(fraq("3/2").toUnicode(), "1½")
  equal(fraq("3/4").toUnicode(), "¾")
  equal(fraq("-1/2").toUnicode(), "-½")
  equal(fraq("1/-2").toUnicode(), "-½")
  equal(fraq("1.0").toUnicode(), "1")

  equal(fraq("1.75").toUnicode(), "1¾")
  equal(fraq("-1.75").toUnicode(), "-1¾")
  equal(fraq("-.75").toUnicode(), "-¾")

  equal(fraq("1/64").toUnicode(64), "¹⁄₆₄")
  equal(fraq("1 1/64").toUnicode(64), "1¹⁄₆₄")
  equal(fraq("1 1/64").toUnicode(), "1")
})
