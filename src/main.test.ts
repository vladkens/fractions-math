...
test("should print to ascii", () => {
  ...
  // equal(fraq(".083").toAscii(true), "1/12")
  // equal(fraq(".0625").toAscii(true), "1/16")
  // equal(fraq(".1875").toAscii(true), "3/16")
  // equal(fraq(".3125").toAscii(true), "5/16")
  // equal(fraq(".4375").toAscii(true), "7/16")
  // equal(fraq(".5625").toAscii(true), "9/16")
  // equal(fraq(".6875").toAscii(true), "11/16")
  // equal(fraq(".8125").toAscii(true), "13/16")
  // equal(fraq(".9375").toAscii(true), "15/16")
})
